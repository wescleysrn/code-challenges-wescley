package com.iamandu.codechallenger.problems.codility.stacksandqueues;
...
public interface Fish {
	...
	Fish number P is represented by A[P] and B[P]. Array A contains the sizes of the fish. All its elements 
	are unique. Array B contains the directions of the fish. It contains only 0s and/or 1s, where:
	...
	More precisely, we say that two fish P and Q meet each other when P < Q, B[P] = 1 and B[Q] = 0, and there 
