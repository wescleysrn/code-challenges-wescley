package com.iamandu.codechallenger.problems.codility.maximumslice;
...
public interface MaxProfit {
	...
	period of N consecutive days. If a single share was bought on day P and sold on day Q, where 
	0 ≤ P ≤ Q < N, then the profit of such transaction is equal to A[Q] − A[P], provided that A[Q] ≥ A[P]. 
