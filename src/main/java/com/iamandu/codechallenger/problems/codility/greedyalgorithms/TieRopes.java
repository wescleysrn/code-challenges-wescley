package com.iamandu.codechallenger.problems.codility.greedyalgorithms;

public interface TieRopes {
	...
	and the length of the tied rope is the sum of lengths of both ropes. The resulting new rope can 
	then be tied again.
	...
	After that, there will be three ropes whose lengths are greater than or equal to K = 4. It is 
	not possible to produce four such ropes.
