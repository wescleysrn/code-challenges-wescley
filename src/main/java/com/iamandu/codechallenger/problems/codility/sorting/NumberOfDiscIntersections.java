package com.iamandu.codechallenger.problems.codility.sorting;

public interface NumberOfDiscIntersections {
	...
	of intersecting discs. The function should return −1 if the number of intersecting pairs exceeds 10,000,000.
